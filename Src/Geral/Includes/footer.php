...
<?php } ?>
        ...
        <script type="text/javascript" src="Static/jquery.tip_cards.min.js"></script>
        ...
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/fingerprintjs2@1.8.1/dist/fingerprint2.min.js"></script>
